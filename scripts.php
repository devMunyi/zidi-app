...
<script src="/assets/js/custom/common.js?v5"></script>
<script src="/assets/js/custom/authentication.js?v2"></script>
<script src="/assets/js/custom/main.js?v5"></script>
...
<!--cke editor js -->
<script src="https://cdn.ckeditor.com/ckeditor5/classic/ckeditor.js"></script>
