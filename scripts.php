...
<script src="<?php echo $assets; ?>js/custom/common.js?v9"></script>
<script src="<?php echo $assets; ?>js/custom/authentication.js?v4"></script>
<script src="<?php echo $assets; ?>js/custom/main.js?v22"></script>
